...
class HowToLayer extends Layer {
    ...
    initiate() {
        ...
        this.playerModel = new Model(images.player1Win, canvasWidth*0.25, canvasHeight*0.75);
        this.screenshot = new Model(images.screenshot, canvasWidth*0.75, canvasHeight*0.75);
        ...
        this.multiParagrapgh = new StrokedText(multi, canvasWidth*0.5, canvasHeight*0.6, true);
